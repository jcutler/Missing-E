...
(function($) {
   ...
   $.extend($.facebox, {
      settings: {
         ...
         opacity      : 0.6,
         overlay      : true,
         loadingImage : extension.getURL('lib/facebox/loading.gif'),
         closeImage   : extension.getURL('lib/facebox/closelabel.png'),
      ...
      <div id="facebox" style="display:none;"> \
         <div class="popup"> \
            ...
            <a href="#" class="close"><img src="' + extension.getURL('lib/facebox/closelabel.png') + '" title="close" class="close_image" /></a> \
         </div> \
      </div>'
      },
      ...
      reveal: function(data, klass) {
         ...
         var contentWidth = $('#facebox .content').empty().append(data).outerWidth();
         $('#facebox .loading').remove();
         var popup = $('#facebox .popup');
         popup.css('width','auto');
         if (popup.width() < contentWidth) {
