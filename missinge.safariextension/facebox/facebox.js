...
(function($) {
   ...
   $.extend($.facebox, {
      settings: {
         ...
         opacity      : 0.6,
         overlay      : true,
         loadingImage : safari.extension.baseURI + 'facebox/loading.gif',
         closeImage   : safari.extension.baseURI + 'facebox/closelabel.png',
      ...
      <div id="facebox" style="display:none;"> \
         <div class="popup"> \
            ...
            <a href="#" class="close"><img src="' + safari.extension.baseURI + 'facebox/closelabel.png' + '" title="close" class="close_image" /></a> \
         </div> \
      </div>'
      },
