...
innerdiv.innerHTML = '<img src="' + chrome.extension.getURL('postCrushes/heart.png') + '" style="opacity:0.6;height:28px;width:29px;" /><div style="position:absolute;top:15%;width:100%;color:#2D4159;font:italic bold 12px/1.4 Arial,Helvetica,sans-serif;">Post your crushes to Tumblr</div>';
